...
def generate_dcim_macro(num_row, num_col, weight_bit_width, input_bit_width): 
    ### modules
    verilog_file_code = ''
    verilog_file_code += '`include "library/verilog/std_cell_lib.v"\n'
    verilog_file_code += f'`include "results/dcim_macro_{num_row}x{num_col}_for_{weight_bit_width}bitx{input_bit_width}bit/frontend/verilog_file/sub_modules/flatten/control_for_{input_bit_width}bit_input_flatten.v"\n\n'
    # decoder
